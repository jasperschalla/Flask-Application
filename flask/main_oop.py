...
def map_data():
    ...
    # with open(r"C:\Users\jaspe\Downloads.json","w") as file:
...
def download_prep():
    ...
    if (file_numb==1):
        ...
        dataset = data_dict[data_dict.keys()[0]]["dataset"]

        js_data = {
            "calc_operator": dataset["calc_operator"],
            "filter_operator": rdataset["filter_operator"],
            "boundaries": dataset["boundaries"],
            "palette": rdataset["palette"],
